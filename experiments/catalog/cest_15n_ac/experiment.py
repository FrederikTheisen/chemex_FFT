...
EXPERIMENT_NAME = "cest_15n_ac"


class Cest15NACSettings(CestSettings):
    name: Literal["cest_15n_ac"]
    time_t1: float
    carrier: float
    b1_frq: float
...
class Cest15NACConfig(ExperimentConfig[Cest15NACSettings, CestDataSettings]):
    @property
...
def build_spectrometer(config: Cest15NACConfig, spin_system: SpinSystem) -> Spectrometer:
...
@dataclass
class Cest15NACSequence:
    settings: Cest15NACSettings
...
def register():
    creators = Creators(
        config_creator=Cest15NACConfig,
        spectrometer_creator=build_spectrometer,
        sequence_creator=Cest15NACSequence,
